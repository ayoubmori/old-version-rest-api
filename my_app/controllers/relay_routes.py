...
class RelayOn(Resource):
    @relay_ns.expect(relay_ns.model('Relay On Input', {
        'relay_id': fields.String(description='ID of the relay to be turned on', required=True, example='relay1')
...
class RelayOff(Resource):
    @relay_ns.expect(relay_ns.model('Relay Off Input', {
    'relay_id': fields.String(description='ID of the relay to be turned off', required=True, example='relay1')
